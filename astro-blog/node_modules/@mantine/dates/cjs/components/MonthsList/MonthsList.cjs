...
const MonthsList = core.factory((_props, ref) => {
  ...
  const rows = months.map((monthsRow, rowIndex) => {
    ...
    return /* @__PURE__ */ React.createElement("tr", { key: rowIndex, ...getStyles("monthsListRow") }, cells);
  });
  return /* @__PURE__ */ React.createElement(core.Box, { component: "table", ref, size, ...getStyles("monthsList"), ...others }, /* @__PURE__ */ React.createElement("tbody", null, rows));
});
