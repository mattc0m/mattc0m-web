...
const DateInput = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Input.Wrapper, { ...wrapperProps, __staticSelector: "DateInput" }, /* @__PURE__ */ React.createElement(
    Popover,
    {
