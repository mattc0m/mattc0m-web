...
const RichTextEditorControlBase = forwardRef(({ className, icon: Icon, ...others }, ref) => /* @__PURE__ */ React.createElement(RichTextEditorControl, { ref, ...others }, /* @__PURE__ */ React.createElement(Icon, { style: { width: rem(16), height: rem(16) } })));
