...
const LinkIcon = (props) => /* @__PURE__ */ React.createElement(Icons.IconLink, { ...props });
const defaultProps = {};
const RichTextEditorLinkControl = core.factory(
  (_props, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(core.Popover.Dropdown, { ...ctx.getStyles("linkEditorDropdown", stylesApiProps) }, /* @__PURE__ */ React.createElement("div", { ...ctx.getStyles("linkEditor", stylesApiProps) }, /* @__PURE__ */ React.createElement(
        core.TextInput,
        {
          ...
          rightSection: /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(Icons.IconExternalLink, { style: { width: core.rem(14), height: core.rem(14) } })
            )
          )
        }
      ), /* @__PURE__ */ React.createElement(
