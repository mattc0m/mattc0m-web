...
const RichTextEditorColorPickerControl = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(core.Popover, { opened, withinPortal: true, trapFocus: true, onClose: close, ...popoverProps }, /* @__PURE__ */ React.createElement(core.Popover.Target, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(core.ColorSwatch, { color: currentColor, size: 14 })
  )), /* @__PURE__ */ React.createElement(core.Popover.Dropdown, { ...getStyles("linkEditorDropdown") }, state === "palette" && /* @__PURE__ */ React.createElement(core.SimpleGrid, { cols: 7, spacing: 2 }, controls), state === "colorPicker" && /* @__PURE__ */ React.createElement(
    core.ColorPicker,
    {
  ...
  ), /* @__PURE__ */ React.createElement(core.Tooltip.Group, { closeDelay: 200 }, /* @__PURE__ */ React.createElement(core.Group, { justify: "flex-end", gap: "xs", mt: "sm" }, state === "palette" && /* @__PURE__ */ React.createElement(
    core.ActionIcon,
    {
      variant: "default",
      onClick: close,
    ...
    /* @__PURE__ */ React.createElement(Icons.IconX, { style: { width: core.rem(16), height: core.rem(16) } })
    ...
    /* @__PURE__ */ React.createElement(Icons.IconCircleOff, { style: { width: core.rem(16), height: core.rem(16) } })
    ...
    /* @__PURE__ */ React.createElement(Icons.IconColorPicker, { style: { width: core.rem(16), height: core.rem(16) } })
  ) : /* @__PURE__ */ React.createElement(
    core.ActionIcon,
    {
      variant: "default",
    ...
    /* @__PURE__ */ React.createElement(Icons.IconPalette, { style: { width: core.rem(16), height: core.rem(16) } })
    ...
    /* @__PURE__ */ React.createElement(Icons.IconCheck, { style: { width: core.rem(16), height: core.rem(16) } })
  )))));
});
