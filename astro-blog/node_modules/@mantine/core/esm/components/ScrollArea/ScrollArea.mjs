...
const ScrollAreaAutosize = factory((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ...others, ref, style: [{ display: "flex" }, style] }, /* @__PURE__ */ React.createElement(Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ React.createElement(
    ScrollArea,
    {
      classNames,
      styles,
