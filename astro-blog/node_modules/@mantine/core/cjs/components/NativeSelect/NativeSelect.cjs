...
const NativeSelect = factory.factory((props, ref) => {
  ...
  const options = getParsedComboboxData.getParsedComboboxData(data).map((item, index) => /* @__PURE__ */ React.createElement(NativeSelectOption.NativeSelectOption, { key: index, data: item }));
  return /* @__PURE__ */ React.createElement(
    InputBase.InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || /* @__PURE__ */ React.createElement(ComboboxChevron.ComboboxChevron, { size, error, unstyled })
    },
    children || options
  );
});
