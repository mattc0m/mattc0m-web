...
const Dialog = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Transition.Transition, { keepMounted, mounted: opened, ...transitionProps }, (transitionStyles) => /* @__PURE__ */ React.createElement(
      Paper.Paper,
      {
        unstyled,
      ...
      withCloseButton && /* @__PURE__ */ React.createElement(CloseButton.CloseButton, { onClick: onClose, unstyled, ...getStyles("closeButton") }),
      children
    ))
  );
});
