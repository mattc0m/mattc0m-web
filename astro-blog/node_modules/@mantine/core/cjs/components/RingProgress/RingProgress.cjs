...
const RingProgress = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("root"), size, ref, ...others }, /* @__PURE__ */ React.createElement("svg", { ...getStyles("svg") }, curves), label && /* @__PURE__ */ React.createElement("div", { ...getStyles("label") }, label));
});
