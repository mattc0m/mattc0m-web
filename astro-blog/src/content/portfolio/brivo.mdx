  ...
  <Grid gutter="var(--spacer-layout-small)">
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Button.png"
    ...
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Colors.png"
        alt="Thumbnail of Brivo One Component from Design System"
        cssClass="hasCaption caption-overlay clickable brivo">
          <div slot="caption">
            Color
    ...
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Forms.png"
        alt="Thumbnail of Brivo One Component from Design System"
        cssClass="hasCaption caption-overlay clickable brivo">
          <div slot="caption">
            Forms & Inputs
    ...
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Layout.png"
        alt="Thumbnail of Brivo One Component from Design System"
        cssClass="hasCaption caption-overlay clickable brivo">
          <div slot="caption">
            Button
    ...
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Modal.png"
        alt="Thumbnail of Brivo One Component from Design System"
        cssClass="hasCaption caption-overlay clickable brivo">
          <div slot="caption">
            Button
    ...
    <GridItem width="25%" cssClass="mobile-half">
      <ImageWrapper
        ...
        href="/images/PortfolioItem/BrivoOne-TH-Typography.png"
        alt="Thumbnail of Brivo One Component from Design System"
        cssClass="hasCaption caption-overlay clickable brivo">
          <div slot="caption">
            Button
